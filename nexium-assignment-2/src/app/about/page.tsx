export default function About() {
  return (
    <div className="flex justify-center items-center bg-gray-100 py-8 px-2 min-h-screen">
      <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-10 max-w-xl w-full flex flex-col items-center mx-auto border border-gray-200">
        ...
        <p className="text-base sm:text-lg text-gray-700 text-center mb-6">
          Welcome to our Blog Summarizer! We are dedicated to providing concise
          and accurate summaries of the latest blog posts, helping you stay
          informed without the hassle of reading lengthy articles.
        </p>
